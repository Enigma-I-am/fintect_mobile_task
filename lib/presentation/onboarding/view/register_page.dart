  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void _submitForm() {
      if (_formKey.currentState!.validate()) {
        // Process login logic with form values
        ref.read(walletVM).register(
              userName: _userName,
              email: _email,
              password: _password,
            );
    ...
    final registerModelState = ref.watch(
      walletVM.select(
        (value) => value.registerModelState,
      ),
    );
          ...
          Row(
            ...
            children: [
              TextButton(
                ...
                child: registerModelState.status == RequestStatus.LOADING
